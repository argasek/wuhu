...
if (array_key_exists('shiftallcompos', $_GET)) {
...
if (array_key_exists('shiftcompo', $_GET) && array_key_exists("shiftid", $_GET)) {
...
if (array_key_exists("delete", $_POST)) {
  ...
  if (array_key_exists("name", $_POST) && array_key_exists("dirname", $_POST)) {
    if ($_POST["id"]) {
      $data = array(
        "name" => $_POST["name"],
...
if (isset($_GET['id'])) {
  ...
  <?php
} else if (isset($_GET["new"]) && $_GET["new"] == "add") {
  ?>
