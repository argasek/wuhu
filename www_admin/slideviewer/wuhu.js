            ...
            onSuccess:(function(transport){
                ...
                switch(mode)
                {
                    ...
                    case "prizegiving":
                    {
                        ...
                        cont.insert(new Element("div", {"class": "wrapper"}));
                        cont = cont.down("div.wrapper");
                        cont.insert(new Element("div", {"class": "header textHuge"}).update("Results"));
                        ...
                        if (this.options.newPrizegiving)
                        {
                            ...
                            var sec = this.insertSlide({"class":"prizegivingSlide eventSlide prizinator"});
                            var cont = sec.down("div.container");
                            cont.insert(new Element("div", {"class": "wrapper"}));
                            cont = cont.down("div.wrapper");
                            this.prizinator = new WuhuPrizinator({"parent":cont,"maxPoints":maxPts,"results":results});
                            cont.insert( new Element("div",{"class":"eventName textMedium newPrizegivingEventName"}).update(compoName) );
                        }
                        else
                        {
                            Element.select(e, "result > results entry").each(function (entry) {
