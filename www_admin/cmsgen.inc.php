...
function cmsRenderListGrid($formdata) {
  ...
  if (isset($formdata["where"])) $sql .= sprintf_esc(" where (%s),", $formdata["where"]);
  if (isset($formdata["order"])) $sql .= sprintf_esc(" order by %s", $formdata["order"]);
  if (isset($formdata["limit"])) $sql .= sprintf_esc(" limit %s", $formdata["limit"]);
  if (isset($formdata["offset"])) $sql .= sprintf_esc(" offset %s", $formdata["offset"]);
